...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            defaults={
                "model_name": "poker44-ensemble-3",
                "model_version": "3.2-public-model-1",
                "framework": "scikit-learn-ensemble",
                "license": "MIT",
                "repo_url": "https://github.com/EmmanuelGreene/poker44-sn126-model-3",
                "notes": "ExtraTrees + HistGradientBoosting ensemble bot detector over behavioral features.",
                "open_source": True,
