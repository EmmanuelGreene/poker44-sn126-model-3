...
def add_args(cls, parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--neuron.name", type=str, help="Neuron name", default="poker44-miner")
...
def _apply_dotted(config_obj, params) -> None:
...
def config(cls) -> bt.Config:
    ...
    # Bittensor v10 keeps only built-in defaults in bt.Config(parser=...), so
    # explicitly apply this subnet's dotted custom args/defaults.
    params, _ = parser.parse_known_args()
    _apply_dotted(cfg, params)
    return cfg
